...
- [x] **فاز ۰** — راه‌اندازی پروژه (settings تفکیک‌شده، django-environ، Git)
- [x] **فاز ۱** — احراز هویت و کاربران (Custom User، JWT، آدرس‌ها)
- [x] **فاز ۲** — کاتالوگ محصولات (دسته‌بندی، برند، محصول + فیلتر و جستجو)
- [x] **فاز ۳** — موجودی (StockItem، جلوگیری از overselling)
- [x] **فاز ۴** — سبد خرید (مهمان + کاربر، merge)
- [x] **فاز ۵** — سفارش‌ها (Checkout و تاریخچه وضعیت)
- [x] **فاز ۶** — پرداخت (زرین‌پال Sandbox)
- [x] **فاز ۷** — تخفیف و کمپین (کد تخفیف)
- [x] **فاز ۸** — نظرات و امتیاز
- [x] **فاز ۹** — پشتیبانی (تیکت)
- [x] **فاز ۱۰** — اعلان‌ها و Celery (ایمیل Async)
- [x] **فاز ۱۱** — سخت‌سازی و Docker (آماده Production)
- [x] **فاز ۱۲** — مستندسازی API (Swagger)
- [x] **فاز ۱۳** — CI با GitHub Actions
