...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        office_laptops, _ = Category.objects.get_or_create(
            name="Office Laptops", slug="office-laptops",
        ...
        self.stdout.write(self.style.SUCCESS(f"  Categories: {Category.objects.count()} created"))
        ...
        self.stdout.write(self.style.SUCCESS(f"  Brands: {Brand.objects.count()} created"))
        ...
        screen, _ = ProductAttribute.objects.get_or_create(name="Screen Size", unit="inch")
        ...
        refresh, _ = ProductAttribute.objects.get_or_create(name="Refresh Rate", unit="Hz")

        self.stdout.write(self.style.SUCCESS(f"  Attributes: {ProductAttribute.objects.count()} created"))
        ...
        products_data = [
            {
                ...
                "is_featured": True,
                "warranty_months": 24,
                "attrs": {ram: "16", storage: "1000", screen: "16", resolution: "2560x1600", refresh: "165"},
            },
            {
                ...
                "is_featured": False,
                "warranty_months": 18,
                "attrs": {ram: "8", storage: "512", screen: "15.6", resolution: "1920x1080"},
            },
            {
                ...
                "is_featured": True,
                "warranty_months": 24,
                "attrs": {ram: "16", storage: "512", screen: "15.6", resolution: "1920x1080", refresh: "144"},
            },
            {
        ...
        self.stdout.write(self.style.SUCCESS(f"  Products: {Product.objects.count()} created"))
